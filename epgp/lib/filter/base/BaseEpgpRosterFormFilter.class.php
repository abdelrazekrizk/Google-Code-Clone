...
/**
 * EpgpRoster filter form base class.
 *
 * @package    epgp
 * @subpackage filter
 ...
 */
class BaseEpgpRosterFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'name'      => new sfWidgetFormFilterInput(),
      'charclass' => new sfWidgetFormPropelChoice(array('model' => 'EpgpClasses', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'charclass' => new sfValidatorPropelChoice(array('required' => false, 'model' => 'EpgpClasses', 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('epgp_roster_filters[%s]');
