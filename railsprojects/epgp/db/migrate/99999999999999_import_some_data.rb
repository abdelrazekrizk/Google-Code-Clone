class ImportSomeData < ActiveRecord::Migration
  def self.up
    ...
    [ ["Vault of Archavon", "VoA"],
      ...
      ["Obsidian Sanctum", "OS"], 
      ["Eye of Eternity", "EoE"],
      ["Ulduar", "ULD"]].each do |z|
      zones[z[0]] = Zone.create :name => z[0], :short_name => z[1]
    end
...
#    admin = User.create :login => "admin", :password => "password", :password_confirmation => "password", :email => "admin@gmail.com"
    domiauser = User.create :login => "domia", :password => "april99", :password_confirmation => "april99", :email => "asuah@gatech.edu"
    gastyuser = User.create :login => "gasty", :password => "fish14", :password_confirmation => "fish14", :email => "gasty.games@gmail.com"
    ehaniuser = User.create :login => "ehani", :password => "password", :password_confirmation => "password", :email => "ehani@gmail.com"


#    throw :lemmie_redo_this_quick_damnit
