CREATE TABLE account (id BIGINT AUTO_INCREMENT, email VARCHAR(255) NOT NULL UNIQUE, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, isadmin TINYINT(1) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE relationship (sourceuserid BIGINT, destinationuserid BIGINT, description VARCHAR(255), accepttime DATE, status BIGINT NOT NULL, PRIMARY KEY(sourceuserid, destinationuserid)) ENGINE = INNODB;
CREATE TABLE school (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, school_type_id BIGINT NOT NULL, INDEX school_type_id_idx (school_type_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE school_type (id BIGINT AUTO_INCREMENT, name VARCHAR(255) NOT NULL UNIQUE, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE user_employer (id BIGINT AUTO_INCREMENT, userid BIGINT NOT NULL, employerid BIGINT NOT NULL, jobtitle VARCHAR(255) NOT NULL, INDEX uniqueness_idx (userid, employerid, jobtitle), INDEX userid_idx (userid), INDEX employerid_idx (employerid), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE user_school (id BIGINT AUTO_INCREMENT, userid BIGINT NOT NULL, schoolid BIGINT NOT NULL, graduationyear BIGINT NOT NULL, UNIQUE INDEX uniqueness_idx (userid, schoolid, graduationyear), INDEX userid_idx (userid), INDEX schoolid_idx (schoolid), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE school ADD CONSTRAINT school_school_type_id_school_type_id FOREIGN KEY (school_type_id) REFERENCES school_type(id);
