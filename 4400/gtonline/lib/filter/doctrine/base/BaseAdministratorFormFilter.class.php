...
/**
 * Administrator filter form base class.
 *
 * @package    gtonline
 * @subpackage filter
 ...
 */
abstract class BaseAdministratorFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('administrator_filters[%s]');
