...
/**
 * StatusUpdate filter form base class.
 *
 * @package    gtonline
 * @subpackage filter
 ...
 */
abstract class BaseStatusUpdateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('status_update_filters[%s]');
